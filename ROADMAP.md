...
- **The evaluator is bimodal** (Apply/Don't clusters, thin Research band). Code-side causes fixed
  (1.42); the fix path is the 👍/👎 feedback ledger → `jobfaro calibrate --feedback` → recalibrate
